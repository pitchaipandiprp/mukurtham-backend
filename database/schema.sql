...
CREATE TABLE IF NOT EXISTS `category_services` (
  ...
  `service_mobile` VARCHAR(100) DEFAULT NULL,
  `service_email` VARCHAR(100) DEFAULT NULL,
  `service_experience` VARCHAR(100) DEFAULT NULL,
  ...
  `completed_events` VARCHAR(100) DEFAULT NULL,
  ...
  `verification_status` JSON DEFAULT NULL,
